...
var restaurants = [
  { id: 1, name: "Dragon Palace", cuisine: "Chinese", rating: 4.5, address: "10 Dumpling Way", is_open: true, tags: ["chinese", "dim-sum", "noodles"], avg_price: 18.5 },
  { id: 2, name: "Bella Napoli", cuisine: "Italian", rating: 4.7, address: "22 Pasta Lane", is_open: true, tags: ["italian", "pizza", "pasta"], avg_price: 22 },
  { id: 3, name: "Spice Route", cuisine: "Indian", rating: 4.3, address: "33 Curry St", is_open: true, tags: ["indian", "curry", "tandoori"], avg_price: 16 },
  { id: 4, name: "Sakura Sushi", cuisine: "Japanese", rating: 4.8, address: "44 Sashimi Blvd", is_open: true, tags: ["japanese", "sushi", "ramen"], avg_price: 28 },
  { id: 5, name: "El Fuego", cuisine: "Mexican", rating: 4.1, address: "55 Taco Terrace", is_open: false, tags: ["mexican", "tacos", "burritos"], avg_price: 14 },
  { id: 6, name: "Le Petit Bistro", cuisine: "French", rating: 4.6, address: "66 Croissant Ct", is_open: true, tags: ["french", "bistro", "wine"], avg_price: 35 },
  { id: 7, name: "Seoul Kitchen", cuisine: "Korean", rating: 4.4, address: "77 Kimchi Ave", is_open: true, tags: ["korean", "bbq", "kimchi"], avg_price: 20 },
  { id: 8, name: "The Burger Joint", cuisine: "American", rating: 4, address: "88 Patty Pl", is_open: true, tags: ["american", "burgers", "fries"], avg_price: 15 }
];
var menuData = {
  ...
  6: [["Coq au Vin", "Braised chicken in red wine", 28.99, "mains", 620], ["French Onion Soup", "Gruy\xE8re-topped onion broth", 12.99, "soups", 380], ["Cr\xE8me Br\xFBl\xE9e", "Vanilla custard with caramel", 11.99, "desserts", 380], ["Duck Confit", "Slow-cooked duck leg", 32.99, "mains", 720], ["Croissant", "Fresh butter croissant", 4.99, "pastries", 280]],
  ...
  8: [["Classic Burger", "Angus beef, lettuce, tomato, cheese", 14.99, "burgers", 780], ["Bacon Cheeseburger", "Double patty with bacon", 17.99, "burgers", 1020], ["Loaded Fries", "Cheese, bacon, jalape\xF1os", 9.99, "sides", 680], ["Milkshake", "Vanilla, chocolate, or strawberry", 7.99, "drinks", 480], ["Chicken Wings (10pc)", "Buffalo or BBQ sauce", 13.99, "appetizers", 720], ["Onion Rings", "Beer-battered onion rings", 8.99, "sides", 540]]
};
var menuItems = [];
var menuId = 1;
...
var nextReviewId = 4;
var promotions = [
  { id: 1, restaurant_id: 1, title: "Dragon Palace Lunch Special", description: "20% off all mains during lunch hours", discount_pct: 20, min_order: 25, promo_code: "DRAGON20", is_active: true, starts_at: "2026-03-01T00:00:00Z", expires_at: "2026-04-01T00:00:00Z" },
  { id: 2, restaurant_id: 2, title: "Bella Napoli Pizza Night", description: "Buy 2 pizzas get 15% off", discount_pct: 15, min_order: 30, promo_code: "PIZZA15", is_active: true, starts_at: "2026-03-10T00:00:00Z", expires_at: "2026-03-31T00:00:00Z" },
  { id: 3, restaurant_id: 4, title: "Sakura Sushi Happy Hour", description: "25% off sushi rolls after 5pm", discount_pct: 25, min_order: 20, promo_code: "SUSHI25", is_active: true, starts_at: "2026-03-01T00:00:00Z", expires_at: "2026-03-25T00:00:00Z" },
  { id: 4, restaurant_id: 6, title: "Le Petit Weekend Brunch", description: "10% off weekend orders over $50", discount_pct: 10, min_order: 50, promo_code: "BRUNCH10", is_active: true, starts_at: "2026-03-15T00:00:00Z", expires_at: "2026-04-15T00:00:00Z" },
  { id: 5, restaurant_id: 7, title: "Seoul Kitchen BBQ Feast", description: "Free delivery on BBQ platters", discount_pct: 0, min_order: 40, promo_code: "BBQFREE", is_active: false, starts_at: "2026-02-01T00:00:00Z", expires_at: "2026-03-01T00:00:00Z" },
  { id: 6, restaurant_id: 3, title: "Spice Route New Customer", description: "30% off first order", discount_pct: 30, min_order: 15, promo_code: "SPICE30", is_active: true, starts_at: "2026-03-01T00:00:00Z", expires_at: "2026-06-01T00:00:00Z" },
...
var nextCartId = 1;
var authMiddleware = bearerAuth({ token: AUTH_TOKEN });
function getUserId() {
  return 1;
}
...
app.get("/api/restaurants/:id", (c) => {
  const r = restaurants.find((r2) => r2.id === parseInt(c.req.param("id")));
...
app.post("/api/cart/items", authMiddleware, async (c) => {
  ...
  if (!carts.has(uid)) {
    carts.set(uid, { id: ++nextCartId, user_id: uid, restaurant_id: mi.restaurant_id, items: [], total: 0, created_at: (/* @__PURE__ */ new Date()).toISOString() });
  }
  const cart = carts.get(uid);
  ...
  cart.total = Math.round(cart.items.reduce((sum, ci) => {
    const m = menuItems.find((m2) => m2.id === ci.menu_item_id);
...
app.post("/api/orders", authMiddleware, async (c) => {
  ...
  const order = {
    ...
    created_at: n,
    updated_at: n,
    estimated_delivery: new Date(Date.now() + 45 * 6e4).toISOString(),
    driver_name: null
  };
  orders.push(order);
  carts.delete(uid);
...
app.get("/api/orders/:id/tracking", authMiddleware, (c) => {
  ...
  return c.json({
    ...
    driver_phone: "+1-555-0200",
    eta: order.estimated_delivery ?? "",
    latitude: 37.7749 + oid * 1e-3,
    longitude: -122.4194 + oid * 1e-3,
...
app.get("/api/search", (c) => {
  ...
  const matchedRests = restaurants.filter(
    (r) => r.name.toLowerCase().includes(ql) || r.cuisine.toLowerCase().includes(ql) || r.tags.some((t) => t.includes(ql))
  );
  const matchedItems = menuItems.filter(
    (m) => m.name.toLowerCase().includes(ql) || m.description.toLowerCase().includes(ql) || m.category.toLowerCase().includes(ql)
  );
